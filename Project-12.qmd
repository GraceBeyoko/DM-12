...
institution <- institution |> 
  rename("Country"="Entity", "LOCATION"= "Code", "Time"= "Year","Value"="stability_dem_inst_bti")|>
...
young_pop |> 
  group_by(Country) |> 
  summarise("min" = min(Population, na.rm=TRUE), "median" = median(Population, na.rm=TRUE), "max"= max(Population, na.rm=TRUE), "mean"= round(mean(Population, na.rm=TRUE),2)) |> 
  head(n=10) |> 
...
On joint illiteracy et expenditure
...
##Illiteracy vs life-expectancy vs rural
